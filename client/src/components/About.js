...
const AboutPage=()=>{
    return (
        <main className="">
            <div className="container center-text hero about-hero">
                <h1 className="heading">About Job Dasher</h1>
            ...
            <div className="about">
                <h2>Simplifying Job Management, One Post at a Time</h2>
                <p>Welcome to Job-Dasher, the ultimate platform designed to make job tracking and management easier, more efficient, and accessible to everyone. Whether you're a professional looking for your next opportunity or a recruiter managing multiple job openings, Job-Dasher is here to empower you with the tools you need.</p>
                <h3>Our Mission</h3>
